package com.gjun.VendingMachineBasic.action;
...
import com.gjun.VendingMachineBasic.model.Member;
import com.gjun.VendingMachineBasic.service.FrontEndService;
import com.gjun.VendingMachineBasic.vo.ConsumerDetails;
import com.gjun.VendingMachineBasic.vo.SearchCondition;
import com.gjun.VendingMachineBasic.vo.ShoppingCartGoodsInfo;
...
public class FrontEndAction extends DispatchAction {
	...
	public ActionForward buyGoods(ActionMapping mapping, ActionForm form, HttpServletRequest req,
		...
		//如果成功購買就清空購物車和清除購物車資訊
		if (consumerDetails.getGiveChange() != inputMoney) {
			session.removeAttribute("carGoods");
		}

		return mapping.findForward("CheckoutCompletionPage");

	}
	

 	public ActionForward buyGoodsView(ActionMapping mapping, ActionForm form, HttpServletRequest req,
 			HttpServletResponse res) throws IOException {

 		return mapping.findForward("CheckoutCompletionPageView");
 	}
